  ...
  return (
    <div className="min-h-screen py-24 bg-ebony-clay-500">
      ...
      <header className="font-bold text-xl mx-auto max-w-full md:max-w-2xl mt-4">
        <h1 className="text-white p-3 font-bold text-2xl">devfinder</h1>
      </header>
      ...
      <div className=" bg-cloud-burst-500 duration-300 rounded-lg space-x-2 flex items-center justify-between max-w-full md:max-w-2xl mx-3 md:mx-auto mt-4 shadow-2xl mb-6 transition p-2 ease-in">
        ...
        <div className="mr-3">
          <button
            className="btn inline-block px-6 py-2 border-2 bg-blue-500 text-white border-blue-600 text-whited text-xs leading-tight font-extrabold rounded hover:bg-black hover:bg-opacity-5 focus:outline-none focus:ring-0 transition duration-150 ease-in-out"
            type="button"
            id="button-addon3"
          >
            Search
        ...
        <section className="flex flex-col md:flex-row mt-5  md:justify-evenly w-full space-y-6 space-x-4 md:space-x-6 items-center">
          ...
          <div className="flex md:flex-1 items-center md:items-start w-full px-2 space-x-6 justify-around md:justify-between ">
            <div className="w-32 md:w-44 font-bold">
              ...
              <p className="inline-block text-sm text-blue-400">@Octocat</p>
            </div>
          ...
          <div className=" bg-ebony-clay-500 rounded-xl shadow-2xl pb-4 mr-6 text-center">
            <div className="rounded-lg bg-primary-dark grid grid-cols-3 divide-x divide-gray-50 py-4">
              <div className="mt-2 text-xs font-semibold text-gray-400">
                Repos
                <div className="text-lg font-extrabold text-gray-50">8</div>
              </div>
              <div className="mt-2 text-xs font-semibold text-gray-400">
                Followers
                <div className="text-lg font-extrabold text-gray-50">2423</div>
              </div>
              <div className="mt-2 text-xs font-semibold text-gray-400">
                Following
                <div className="text-lg font-extrabold text-gray-50">8</div>
